...
final class archives {
    ...
    public static function definition(): array {
        return [
            ...
            'title' => 'Registraire UCC',
            'subtitle' => 'Traces publiques, sources, décisions, corrections et repères de compréhension.',
            'summary' => 'Le registraire rend accessibles les traces utiles à la mémoire vivante de l’UCC. Il soutient la diffusion du savoir, la vérification publique et la compréhension des transformations institutionnelles.',
            'sections' => [
                [
                    'title' => 'Une mémoire publique vivante',
                    'body' => 'Le registraire n’est pas un simple dépôt de fichiers. Il organise les traces publiques qui permettent de comprendre l’évolution de l’UCC, ses décisions, ses méthodes, ses corrections et ses productions.',
                ],
                [
                ...
                [
                    'title' => 'Usage',
                    'body' => 'Le registraire sert à lire, vérifier, relier, transmettre et corriger. Il fait partie de la bibliothèque publique de l’UCC : un espace ouvert pour suivre le savoir, ses sources et ses transformations.',
                ],
            ],
            ...
            'cards' => [
                ...
                [
                    'title' => 'Transmission',
                    'body' => 'Soutenir la diffusion ouverte du savoir UCC.',
                    'type' => 'knowledge',
                ],
            ],
            'notices' => [
                [
                    ...
                    'body' => 'Les contenus visibles ici appartiennent à la mémoire publique de l’UCC. Ils doivent rester lisibles, vérifiables, contextualisés et respectueux des permissions.',
                    'type' => 'info',
                ],
            ],
        ];
