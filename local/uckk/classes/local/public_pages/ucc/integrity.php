...
final class integrity {
    ...
    public static function definition(): array {
        return [
            ...
            'summary' => 'L’intégrité UCC protège la dignité des personnes, la provenance des traces, la lisibilité du savoir et la confiance nécessaire à une diffusion publique des connaissances.',
            'sections' => [
                [
                    'title' => 'Principe',
                    'body' => 'UCC ouvre des connaissances au public sans transformer les personnes en objets d’exposition. Une trace utile doit rester proportionnée, contextualisée et respectueuse de celles et ceux qu’elle concerne.',
                ],
                [
            ...
            'cards' => [
                ...
                [
                    ...
                    'body' => 'Publier des contenus utiles, vérifiables, proportionnés et alignés avec la mission ouverte de l’UCC.',
                    'type' => 'boundary',
                ],
            ],
            'notices' => [
