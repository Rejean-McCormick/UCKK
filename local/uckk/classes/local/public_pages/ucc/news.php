...
final class news {
    ...
    public static function definition(): array {
        return [
            ...
            'title' => 'Journal public UCC',
            'subtitle' => 'Annonces, publications, appels ouverts et jalons d’une bibliothèque vivante.',
            'summary' => 'Le journal public suit l’évolution de l’UCC : nouvelles publications, appels à contribution, ouvertures de parcours, enrichissements de la médiathèque, corrections et repères utiles pour comprendre ce qui change.',
            'sections' => [
                [
                    'title' => 'Fonction',
                    'body' => 'Les nouvelles rendent visible le travail public de l’UCC : diffuser le savoir, annoncer les ressources ouvertes, documenter les jalons et inviter à participer lorsque des contributions sont possibles.',
                ],
                [
            ...
            'cards' => [
                ...
                [
                    'title' => 'Jalons',
                    'body' => 'Moments importants dans le développement de l’UCC, de ses Voies, de sa médiathèque, de ses archives ou de ses outils.',
                    'type' => 'milestones',
                ],
                [
                    'title' => 'Publications',
